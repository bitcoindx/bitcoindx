BitcoinDX Core version 0.9.4 is now available from:

  https://bitcoindx.org/bin/0.9.4/
...
this update is incompatible with the BitcoinDX system and could lead to consensus
forks.

BitcoinDX Core released binaries from https://bitcoindx.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoindx/+archive/ubuntu/bitcoindx
- A third-party or self-compiled BitcoinDX Core

upgrade to BitcoinDX Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
