...
bitcoin-dx.org and bitcoindx.org and compares them.
...
WORKINGDIR = "/tmp/bitcoindx_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://bitcoin-dx.org"
HOST2 = "https://bitcoindx.org"
VERSIONPREFIX = "bitcoindx-core-"
...
def main(args):
    ...
    if not success:
        print("bitcoindx.org failed to provide signature file, "
              "but bitcoin-dx.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bitcoindx.org and bitcoin-dx.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the BitcoinDX Core binary release "
