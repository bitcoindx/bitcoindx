BitcoinDX Core version 0.10.3 is now available from:

  <https://bitcoindx.org/bin/bitcoindx-core-0.10.3/>
...
(see https://github.com/bitcoindx/bitcoindx/pull/6793, as well as the 0.11.0
