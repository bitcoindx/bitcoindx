...
#ifndef BITCOINDX_QT_BITCOINDXGUI_H
#define BITCOINDX_QT_BITCOINDXGUI_H
...
/**
  BitcoinDX GUI main class. This class represents the main window of the BitcoinDX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitcoinDXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitcoinDXGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitcoinDXGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoindx wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitcoinDX Transaction from file or clipboard */
...
#endif // BITCOINDX_QT_BITCOINDXGUI_H
