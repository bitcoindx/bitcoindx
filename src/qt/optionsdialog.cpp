    ...
    mapper(nullptr)
{
    ...
    ui->bitcoindxAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoindxAtStartup);
    ...
    ui->bitcoindxAtStartup->setToolTip(ui->bitcoindxAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoindxAtStartup->setText(ui->bitcoindxAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinDXConfButton->setToolTip(ui->openBitcoinDXConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinDXUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoindxAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinDXConfButton_clicked()
{
