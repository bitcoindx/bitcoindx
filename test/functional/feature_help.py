...
"""Verify that starting bitcoindx with -h works as expected."""

from test_framework.test_framework import BitcoinDXTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinDXTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoindx with -h for help text")
        ...
        self.log.info("Start bitcoindx with -version for version information")
        ...
        self.log.info("Start bitcoindxd with -fakearg to make sure it does not start")
