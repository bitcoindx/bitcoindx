BitcoinDX Core version 0.16.1 is now available from:

  <https://bitcoin-dx.org/bin/bitcoindx-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoindxd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoindxd processes are cleaned up when tests end (sdaftuar)
