...
This document provides guidelines for internationalization of the BitcoinDX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoindx_en.ts` remains unchanged.
