...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinDXTestFramework
    pass


class ExampleTest(BitcoinDXTestFramework):
    # Each functional test is a subclass of the BitcoinDXTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinDXTestFramework class so other tests can use it."""
