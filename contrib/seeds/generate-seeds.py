...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINDX_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINDX_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoindx network\n')
    ...
    g.write('#endif // BITCOINDX_CHAINPARAMSSEEDS_H\n')
