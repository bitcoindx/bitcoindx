...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitcoinDX
else
  DOCKER_EXEC echo \> \$HOME/.bitcoindx
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitcoindx/bitcoindx/pull/18288#discussion_r433189350 for
  # details.
