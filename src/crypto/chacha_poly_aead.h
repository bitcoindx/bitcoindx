...
#ifndef BITCOINDX_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINDX_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoindx.
 *
 ...
 *
 * The chacha20-poly1305@bitcoindx combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoindx cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoindx are relatively fast in
...
#endif // BITCOINDX_CRYPTO_CHACHA_POLY_AEAD_H
