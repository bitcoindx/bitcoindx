...
#ifndef BITCOINDX_QT_GUIUTIL_H
#define BITCOINDX_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinDX Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoindx:" URI into recipient object, return true on successful parsing
