BitcoinDX-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoindx/files/BitcoinDX/bitcoindx-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinDX
...
New/changed settings (command-line or bitcoindx.conf file)
--------------------------------------------------------
