...
#ifndef BITCOINDX_CHAINPARAMSBASE_H
#define BITCOINDX_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between bitcoindx-cli and bitcoindxd)
 * of a given instance of the BitcoinDX system.
 */
...
#endif // BITCOINDX_CHAINPARAMSBASE_H
