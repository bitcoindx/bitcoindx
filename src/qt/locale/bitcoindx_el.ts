...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Αυτές είναι οι BitcoinDX διευθύνσεις σας για να στέλνετε πληρωμές. Να ελέγχετε πάντα το ποσό, καθώς και τη διεύθυνση παραλήπτη πριν στείλετε νομίσματα.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Αυτές είναι οι BitcoinDX διευθύνσεις για την λήψη πληρωμών. Χρησιμοποιήστε το κουμπί  'Δημιουργία νέας διεύθυνσης λήψεων' στο παράθυρο λήψεων για την δημιουργία νέας διεύθυνσης.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Προσόχη! Εάν κρυπτογραφήσεις το πορτοφόλι σου και χάσεις τη φράση αποκατάστασης, θα &lt;b&gt; ΧΑΣΕΙΣ ΟΛΑ ΣΟΥ ΤΑ BITCOINDX &lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα bitcoindxs σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Εισάγετε μια διεύθυνση BitcoinDX (π.χ. %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Στείλε νομίσματα σε μια διεύθυνση bitcoindx</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Υπογράψτε ένα μήνυμα για ν' αποδείξετε πως ανήκει μια συγκεκριμένη διεύθυνση BitcoinDX</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις bitcoindx: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed BitcoinDX</translation>
    </message>
    <message>
        <source>Load Partially Signed BitcoinDX Transaction from clipboard</source>
        <translation type="unfinished">Φόρτωση συναλλαγής Partially Signed BitcoinDX από το πρόχειρο</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε ένα bitcoindx: URI</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Εμφάνισε το %1 βοηθητικό μήνυμα για λήψη μιας λίστας με διαθέσιμες επιλογές για BitcoinDX εντολές </translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n ενεργές συνδέσεις στο δίκτυο BitcoinDX.</numerusform>
            <numerusform>%n ενεργές συνδέσεις στο δίκτυο BitcoinDX.</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση "%1" δεν είναι έγκυρη BitcoinDX διεύθυνση.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Το %1 θα κατεβάσει και θα αποθηκεύσει ένα αντίγραφο της αλυσίδας μπλοκ BitcoinDX.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η προσπάθεια να δαπανήσετε bitcoindxs που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ανοίξτε το bitcoindx URI</translation>
    </message>
    </context>
<context>
    ...
    <message>
        ...
        <translation>Αυτόματο άνοιγμα των θυρών BitcoinDX στον δρομολογητή. Λειτουργεί μόνο αν ο δρομολογητής σας υποστηρίζει τη λειτουργία UPnP.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Σύνδεση στο δίκτυο BitcoinDX μέσω διαμεσολαβητή SOCKS5 (π.χ. για σύνδεση μέσω Tor)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Συνδεθείτε στο δίκτυο BitcoinDX μέσω ενός ξεχωριστού διακομιστή μεσολάβησης SOCKS5 για τις onion υπηρεσίες του Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Οι πληροφορίες που εμφανίζονται μπορεί να είναι ξεπερασμένες. Το πορτοφόλι σας συγχρονίζεται αυτόματα με το δίκτυο BitcoinDX μετά από μια σύνδεση, αλλά αυτή η διαδικασία δεν έχει ακόμη ολοκληρωθεί.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Δεν είναι δυνατή η εκκίνηση του bitcoindx: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">'bitcoindx: //' δεν είναι έγκυρο URI. Χρησιμοποιήστε το "bitcoindx:" αντ 'αυτού.</translation>
    </message>
    <message>
        <source>URI cannot be parsed! This can be caused by an invalid BitcoinDX address or malformed URI parameters.</source>
        <translation type="unfinished">Δεν είναι δυνατή η ανάλυση του URI! Αυτό μπορεί να προκληθεί από μη έγκυρη διεύθυνση BitcoinDX ή παραμορφωμένες παραμέτρους URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα προαιρετικό μήνυμα που επισυνάπτεται στο αίτημα πληρωμής, το οποίο θα εμφανιστεί όταν το αίτημα ανοίξει. Σημείωση: Το μήνυμα δεν θα αποσταλεί με την πληρωμή μέσω του δικτύου BitcoinDX.</translation>
    </message>
    <message>
...
Προειδοποίηση: Προς το παρόν δεν είναι δυνατή η εκτίμηση των εξόδων..</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές bitcoindx από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Παρακαλούμε, ελέγξτε την πρόταση συναλλαγής. Θα παραχθεί μια συναλλαγή BitcoinDX με μερική υπογραφή (PSBT), την οποία μπορείτε να αντιγράψετε και στη συνέχεια να υπογράψετε με π.χ. ένα πορτοφόλι %1 εκτός σύνδεσης ή ένα πορτοφόλι υλικού συμβατό με το PSBT.</translation>
    </message>
    <message>
...
Δεν σηματοδοτεί την Aντικατάσταση-Aπό-Έξοδο, BIP-125.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Προειδοποίηση: Μη έγκυρη διεύθυνση BitcoinDX</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Η διεύθυνση BitcoinDX που θα σταλεί η πληρωμή</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα bitcoindxs από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ένα μήνυμα που επισυνάφθηκε στο bitcoindx: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου BitcoinDX.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Υπογράψτε το μήνυμα για να αποδείξετε πως σας ανήκει η συγκεκριμένη διεύθυνση BitcoinDX</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
    ...
    <message>
        ...
        <translation type="unfinished">Διεύθυνση BitcoinDX με την οποία έχει υπογραφεί το μήνυμα</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Επαληθεύστε το μήνυμα για να αποδείξετε πως υπογράφθηκε από τη συγκεκριμένη διεύθυνση BitcoinDX</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Επιβεβαίωση Mηνύματος</translation>
