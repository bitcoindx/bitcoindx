...
#ifndef BITCOINDX_COMPAT_ASSUMPTIONS_H
#define BITCOINDX_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinDX cannot be compiled without assertions."
#endif
...
#endif // BITCOINDX_COMPAT_ASSUMPTIONS_H
