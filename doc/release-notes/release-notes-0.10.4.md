BitcoinDX Core version 0.10.4 is now available from:

  <https://bitcoindx.org/bin/bitcoindx-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoindx-tx into its own package
- #6953 `dfe0d4d` Include bitcoindx-tx binary on Debian/Ubuntu
