...
// bitcoindx includes.
#include <..\src\script\bitcoindxconsensus.h>
...
int main()
{
    std::cout << "bitcoindxconsensus version: " << bitcoindxconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoindxconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, bitcoindxconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
