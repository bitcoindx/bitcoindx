...
#ifndef BITCOINDX_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINDX_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINDX_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
