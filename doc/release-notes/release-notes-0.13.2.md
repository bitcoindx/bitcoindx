BitcoinDX Core version 0.13.2 is now available from:

  <https://bitcoindx.org/bin/bitcoindx-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoindx-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoindx-tx to create v2 transactions (btcdrak)
