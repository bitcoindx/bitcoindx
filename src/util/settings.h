...
#ifndef BITCOINDX_UTIL_SETTINGS_H
#define BITCOINDX_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoindx/bitcoindx/pull/15934/files#r337691812)
...
#endif // BITCOINDX_UTIL_SETTINGS_H
