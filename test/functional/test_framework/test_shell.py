...
class TestShell:
    """Wrapper Class for BitcoinDXTestFramework.

    The TestShell class extends the BitcoinDXTestFramework
    ...
    class __TestShell(BitcoinDXTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinDXTestFramework child class.
            self.num_nodes = 1
