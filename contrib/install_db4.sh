#!/bin/sh
# Copyright (c) 2017-2019 The BitcoinDX Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoindx repository."
  exit 1
fi
...
# See https://github.com/bitcoindx/bitcoindx/issues/16064
...
echo 'When compiling bitcoindxd, run `./configure` in the following way:'
echo
