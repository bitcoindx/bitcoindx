BitcoinDX version 0.6.2 is now available for download at:
http://sourceforge.net/projects/bitcoindx/files/BitcoinDX/bitcoindx-0.6.2/
...
Fixed https://github.com/bitcoindx/bitcoindx/issues/1065, a bug that
