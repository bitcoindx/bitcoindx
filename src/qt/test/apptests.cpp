...
//! Entry point for BitcoinDXApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinDXApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinDXGUI tests.
void AppTests::guiTests(BitcoinDXGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinDXGUI::consoleShown, this, &AppTests::consoleTests);
