...
class P2PPermissionsTests(BitcoinDXTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitcoindxconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitcoindxconf, 'w', encoding="utf8") as f:
            f.write(newText)
