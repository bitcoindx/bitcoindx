 ...
 */
#ifndef BITCOINDX_UTIL_SYSTEM_H
#define BITCOINDX_UTIL_SYSTEM_H
...
extern const char * const BITCOINDX_CONF_FILENAME;
extern const char * const BITCOINDX_SETTINGS_FILENAME;
