...
// Copyright (c) 2009-2019 The BitcoinDX Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOINDX_RPC_PROTOCOL_H
#define BITCOINDX_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoindxd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinDX is not connected
...
#endif // BITCOINDX_RPC_PROTOCOL_H
