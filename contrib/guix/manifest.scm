...
(define* (make-bitcoindx-cross-toolchain target
                                       #:key
...
desirable for building BitcoinDX Core release binaries."
...
(define glibc-2.27/bitcoindx-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-bitcoindx-cross-toolchain target
                                                      #:base-libc glibc-2.27/bitcoindx-patched
