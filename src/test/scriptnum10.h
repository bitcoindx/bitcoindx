...
#ifndef BITCOINDX_TEST_SCRIPTNUM10_H
#define BITCOINDX_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinDX Core 0.10.0, for cross-comparison.
 */
public:
