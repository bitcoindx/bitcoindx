...
By default, bitcoindxd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinDXTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoindxd from writing mempool.dat to disk. Verify that `savemempool` fails")
