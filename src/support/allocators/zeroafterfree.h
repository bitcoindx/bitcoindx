...
#ifndef BITCOINDX_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINDX_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINDX_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
