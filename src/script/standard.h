 ...
 *  A CTxDestination is the internal data type encoded in a bitcoindx address
 */
...
/**
 * Generate a BitcoinDX scriptPubKey for the given CTxDestination. Returns a P2PKH
