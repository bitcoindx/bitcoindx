...
#ifndef BITCOINDX_SCRIPT_SCRIPT_H
#define BITCOINDX_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinDX always counted CHECKMULTISIGs
...
#endif // BITCOINDX_SCRIPT_SCRIPT_H
