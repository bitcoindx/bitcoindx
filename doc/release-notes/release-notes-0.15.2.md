BitcoinDX Core version *0.15.2* is now available from:

  <https://bitcoin-dx.org/bin/bitcoindx-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitcoindx-tx (TheBlueMatt)
