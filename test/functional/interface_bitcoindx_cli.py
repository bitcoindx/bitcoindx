...
# v22.0.11 Reverted to 100 & 59931 by Team DX.
...
class TestBitcoinDXCli(BitcoinDXTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoindx-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitcoindx-cli getwalletinfo return expected wallet info")
            ...
            # Test bitcoindx-cli -generate with -rpcwallet in multiwallet mode.
