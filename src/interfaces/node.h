...
#ifndef BITCOINDX_INTERFACES_NODE_H
#define BITCOINDX_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoindx node (bitcoindxd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINDX_INTERFACES_NODE_H
