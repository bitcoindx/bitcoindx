...
#ifndef BITCOINDX_UTIL_MESSAGE_H
#define BITCOINDX_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoindx address, it must refer to a public key.
...
#endif // BITCOINDX_UTIL_MESSAGE_H
