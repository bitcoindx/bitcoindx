...
#ifndef BITCOINDX_WALLET_ISMINE_H
#define BITCOINDX_WALLET_ISMINE_H
 ...
 * https://github.com/bitcoindx/bitcoindx/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // BITCOINDX_WALLET_ISMINE_H
