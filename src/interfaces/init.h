...
#ifndef BITCOINDX_INTERFACES_INIT_H
#define BITCOINDX_INTERFACES_INIT_H
...
//! (bitcoindx-gui, bitcoindx-node, bitcoindx-wallet, bitcoindxd, bitcoindx-qt) and each
...
#endif // BITCOINDX_INTERFACES_INIT_H
